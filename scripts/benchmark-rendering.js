...
async function executeTarget(target, strategy, repetition) {
  ...
  return {
    ...
    primaryCoverage: scores.primaryCoverage,
    diagnosticCoverage: scores.diagnosticCoverage,
    inventoryCoverage: scores.inventoryCoverage,
    renderRequiredCoverage: scores.renderRequiredCoverage,
